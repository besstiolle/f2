...
<fieldset>
  ...
  <div class="pageoverflow">
    <p class="pagetext">{$mod->Lang('prompt_enhancedpw')}:</p>
    <p class="pageinput">
      {cge_yesno_options prefix=$actionid name=enhancedpw selected=$enhancedpw}
      <br/>
      {$mod->Lang('info_enhancedpw')}
    </p>
  </div>
  <div class="pageoverflow">
    <p class="pagetext">{$mod->Lang('prompt_pwrequiredchars')}:</p>
    <p class="pageinput">
      <input type="text" name="{$actionid}pwrequiredchars" value="{$pwrequiredchars}" maxlength="40"/>
      <br/>
      {$mod->Lang('info_pwrequiredchars')}
    </p>
  </div>
