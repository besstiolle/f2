...
// returns true/false
    function IsValidPassword( $password )
    {
        ...
        $enhancedpw = (int) $module->GetPreference('enhanced_password',0);
        $requiredchars = $module->GetPreference('password_requiredchars');
        $len = strlen($password);
...
// userid api function
    ...
    function GetUserID($username)
    {
        ...
        return $this->_useridbyname[$username];
    }
