...
$lang['editcategory'] = 'Editer une catégorie';
...
$lang['help_article_content'] = 'Entrer dans l\'article détaillé contenu ici';
...
$lang['help_article_extra'] = 'Il s\'agit de données supplémentaires à associer à l\'article. Il peuvent être utilisées pour un ordre de tri ou autre comportement. Quant à l\'utilisation de ce champ (ou pas), vous devez consulter votre développeur du site.';
...
$lang['help_article_status'] = 'Si vous souhaitez que l\'article pour être immédiatement visible par les autres, sélectionnez le statut  "Publié". Si vous souhaitez continuer à travailler sur cet article pendant un certain temps, puis sélectionnez  le statut  "Ébauche".';
...
$lang['noarticlesinfilter'] = 'Il n\'y a aucun article pour utiliser ce filtre';
...
$lang['viewfilter'] = 'Voir les filtres';
