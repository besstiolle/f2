...
$lang['info_cache_age'] = 'Spécifie l\'âge maximum d\'un fichier-image (en jours) avant qu\'il soit supprimé et regénéré. Ceci est utile si vous avez changé certains paramètres de génération d\'images, ou pour réguler l\'espace disque utilisé. Une valeur de "0" désactive la suppression automatique.';
...
$lang['param_filter_pixelate'] = '(taille[,avancé]) Pixélise l\'image. Spécifiez un entier pour le poids et une valeur booléenne optionnelle (true/false - false par défaut) pour permettre une pixélisation avancée.';
