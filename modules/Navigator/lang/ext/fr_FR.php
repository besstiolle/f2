...
$lang['help'] = '<h3>Que fait ce module&nbsp;?</h3>
  <p>Le module "Navigator" permet de gérer les menus de navigation du contenu et des gabarits de CMSMS™. Ce module fournit des fonctionnalités de filtrage flexibles pour permettre la construction de nombreuses navigations sur la base de différents critères, avec une simple hiérarchie des données pour générer des navigations avec une flexibilité totale.</p>
...
$lang['help_excludeprefix'] = 'Exclure tous les éléments (et leurs enfants) auquel l\'alias de page correspond à l\'un des préfixes (séparés par des virgules). Ce paramètre ne doit pas être utilisé en conjonction avec le paramètre includeprefix.';
...
$lang['help_start_text'] = 'Utile que dans l\'action breadcrumbs, ce paramètre permet de spécifier un texte facultatif pour afficher au début de la navigation de la barre de navigation. Un exemple serait "Ici".';
