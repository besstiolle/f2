...
<ul>
 ...
 <h3>Comment l\'utiliser ? </h3>
  <ul>
    ...
    <li>Choisir MicroTiny comme éditeur WYSIWYG dans dans "Mon compte/Préférences utilisateur/Sélection du WYSIWYG à utiliser"</li>
  </ul>
    ...
    <dt>Q : Je ne vois pas l\'éditeur MicroTiny dans l\'interface administration, que puis-je faire ?</dt>
      <dd>R : Il y a quelques étapes que vous pouvez suivre pour diagnostiquer ce problème :
        <ol>
          ...
          <li>Vérifiez que MicroTiny est sélectionné dans "Sélection du WYSIWYG à utiliser" à utiliser dans le menu "Mes préférences/Mon compte/Préférences utilisateur"</li>
...
$lang['image'] = 'Image&nbsp;';
$lang['info_linker_autocomplete'] = 'Commencez par taper quelques caractères de la page alias, texte du menu ou titre désiré. Tous les noms correspondantes seront affichés dans une liste.';
