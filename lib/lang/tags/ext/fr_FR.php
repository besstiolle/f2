...
$lang['help_modifier_cms_date_format'] = '<h3>Que fait cette balise ?</h3>
 <p>Ce modificateur est utilisé pour formater des dates dans un format adapté. Il utilise les paramètres standard de "strftime". Si aucune chaîne de format n\'est spécifiée, le système utilisera le "Format de la date" du "Mon compte/Préférences utilisateur" (pour les utilisateurs connectés) ou le format des dates du système.</p>
...
$lang['help_modifier_relative_time'] = '<h3>Que fait cette balise ?</h3>
  <p>Ce modificateur convertit un entier timestamp ou la chaîne time/date vers une durée de temps compréhensible à partir du temps T ou de maintenant. Ex. : "3 hours ago." (il y a 3 heures)</p>
<h3>Comment l\'utiliser ?</h3>
...
<p>C\'est un plugin d\'administration uniquement, permettant aux modules d\'afficher facilement les icônes du thème administration actuelle. Ces icônes sont utiles dans la construction des liens ou pour afficher des informations d\'état.</p>
...
<ul>
  ...
  <li>assign - <em>(option)</em> - Assigne la sortie de la balise à la variable Smarty nommée.</li>
</ul>
<h3>Exemple :</h3>
<pre><code>{admin_icon icon=\'edit.gif\' class=\'editicon\'}</code></pre>';
$lang['help_function_cms_action_url'] = '<h3>Que fait cette balise ?</h3>
<p>Ceci est un plugin intelligent utile pour générer une URL avec une action de module. Ce plugin est utile pour les développeurs de modules qui génèrent des liens (que ce soit pour Ajax ou dans l\'interface administration) pour réaliser des fonctionnalités différentes ou afficher des données différentes.</p>
<h3>Quels paramètres ?</h3>
<ul>
  <li>module - <em>(option)</em> - Le nom du module pour générer une URL. Ce paramètre n\'est pas nécessaire si la génération d\'une URL à partir d\'une action du module à une action dans le même module.</li>
  <li>action - <strong>(requis)</strong> - Le nom de l\'action qui génère une URL.</li>
  <li>returnid - <em>(option)</em> - Entier  (integer) PageId pour afficher les résultats de l\'action. Ce paramètre n\'est pas nécessaire si l\'action doit être affiché sur la page courante, ou si l\'URL est suite à une action d\'administration depuis une action d\'administration.</li>
  <li>mid - <em>(option)</em> - Le module ActionId. Par défaut, c\'est "m1_" pour des actions d\'administration, et "cntnt01" pour les actions sur le site Web (frontend).</li>
  <li>forjs - <em>(option)</em> - Entier (integer) facultatif qui indique que l\'URL générée doit être adapté pour une utilisation en JavaScript.</li>
  <li>assign - <em>(option)</em> -  Assigne la sortie URL de la balise à la variable Smarty nommée.</li>
</ul>
<p><strong>Note :</strong> Tous les autres paramètres qui ne sont pas acceptés par ce plugin sont automatiquement transmises à l\'action du module par l\'URL générée.</p>
<h3>Exemple :</h3>
...
<p>Ce plugin administrateur donne une information sur l\'ID de l\'utilisateur "Admin".</p>
<h3>Quels paramètres ?</h3>
<ul>
  ...
  <li>mode - <em>(option)</em> - Le mode de fonctionnement. Les valeurs possibles sont :
    <ul>
      <li>username <strong>default</strong> - donner le nom d\'utilisateur pour l\'UID spécifié.</li>
      <li>email - donner l\'adresse email de l\'UID indiqué.</li>
      <li>firstname - donner le prénom de l\'UID indiqué.</li>
      <li>lastname - donner le nom de famille de l\'UID indiqué.</li>
...
<p>C\'est plugin d\'administration uniquement, utilisé pour générer un lien qui lorsqu\'il est cliqué va générer une aide contextuelle pour un élément particulier.</p>
...
<ul>
  ...
  <li>realm - <em>(option string)</em> - La première partie d\'une clé unique pour identifier la chaîne d\'aide. Si ce paramètre n\'est pas précisé, ce plugin est appelé à partir d\'une action de module, puis le nom du module en cours est utilisé. Si aucun nom de module peut être trouvé alors "help" dans la langue utilisateur.</li>
...
$lang['help_function_cms_init_editor'] = '<h3>Que fait cette balise ?</h3>
  <p>Cette balise est utilisée pour initialiser les fonctionnalités WYSIWYG de l\'éditeur WYSIWYG pour la soumission des données du site Web (frontend). Ce module sélectionnera le WYSIWYG du site Web (frontend) em>(Menu Paramètres globaux/Paramètres généraux )</em>, s\'il a été demandé, et générera le <em>code HTML approprié (les liens JavaScript)</em> pour l\'affichage correct de la page chargée. Si aucun éditeur WYSIWYG n\'est demandé cette balise n\'aura aucun effet.</p>
<h3>Comment l\'utiliser ?</h3>
...
$lang['help_function_cms_pageoptions'] = '<h3>Que fait cette balise ?</h3>
 <p>C\'est un simple plugin, pour générer une séquence de balises "Option" pour une liste déroulante de pagination qui représentent les numéros de page.</p>
 <p>Compte tenu du nombre de pages et de la page actuelle ce plugin va générer une liste de numéros de pages qui permettent une navigation rapide vers sous-ensemble des pages.</p>
<h3>Quels paramètres ?</h3>
  <ul>
    ...
    <li>surround - <em>(option integer)</em> - Le nombre d\'élément pour entourer la page courante par. La valeur par défaut de ce paramètre est 3.</li>
...
<p>Ce plugin va générer une traduction une "Option" Oui/Non, avec la valeur sélectionnée appropriée.</p>
<h3>Quels paramètres ?</h3>
<ul>
  <li>selected - <em>(option integer)</em> - soit 0 <em>(no)</em> ou 1 <em>(yes)</em></li>
  <li>assign - <em>(option string)</em> - Assigne le résultat à une variable Smarty avec ce nom.</li>
</ul>
<h3>Exemple :</h3>
...
<p>Cette balise détecte la langue du navigateur, utilisée et définie par l\'utilisateur, et les références croisées si une liste des langues détermine une valeur de la langue de session.</p>
<h3>Comment l\'utiliser ?</h3>
<p>Insérer la balise dans votre gabarit :  <em>(il peut être  au-dessus la section < head > si vous voulez)</em> et lui indiquer le nom de la langue par défaut, et les langues acceptées (seul deux caractères de noms de langue sont acceptés), puis utiliser le résultat. Exemple :</p>
...
<ul>
	...
	<li><em>(option)</em> assign - Le nom de la variable Smarty pour affecter les résultats. Si non pas spécifié les résultats de cette fonction sont retournés.</li>
</ul>';
...
<ul>
	...
	<li><em>(option)</em> nocombine - (boolean, par défaut false) si activé, et si il y a plusieurs feuilles de style associées au gabarit, les feuilles de style seront séparées  au lieu d\'être combinées en une seule balise de feuille de style.</li>
...
<ul>
  ...
  <li><em>(option)</em> default=\'\' - Utilisé pour définir une image par défaut lorsque aucune image n\'est sélectionnée.</li>
...
$lang['help_function_tab_end'] = '<h3>Que fait cette balise ?</h3>
  <p>Ce plugin génère le code HTML pour indiquer la fin d\'une zone de contenu.</p>
<h3>Comment l\'utiliser ?</h3>
...
<h3>Quels paramètres ?</h3>
<ul>
   <li>assign - <em>(option)</em> - Assigne le résultat à une variable Smarty avec ce nom.</li>
</ul>
<h3>Voir Aussi :</h3>
  <ul>
    <li>{tab_header}</li>
...
$lang['help_function_tab_header'] = '<h3>Que fait cette balise ?</h3>
  <p>Ce plugin génère le code HTML pour délimiter le "header" pour un seul onglet dans une zone de contenu à onglets.</p>
<h3>Comment l\'utiliser ?</h3>
<p>Le code suivant crée une zone de contenu à onglets avec deux onglets.</p>
...
<ul>
   ...
   <li>active - <em>option mixed</em> - Indique s\'il s\'agit de l\'onglet actif ou non. Vous pouvez passer dans le nom (string) de l\'onglet actif dans une séquence d\'onglets "headers", ou une valeur booléenne.</li>
   <li>assign - <em>(option)</em> - Assigne le résultat à une variable Smarty avec ce nom.</li>
</ul>
<h3>Voir Aussi :</h3>
  <ul>
...
$lang['help_function_tab_start'] = '<h3>Que fait cette balise ?</h3>
  <p>Ce plugin fournit le code HTMLl pour délimiter le début du contenu d\'un onglet spécifique dans une zone de contenu à onglets.</p>
<h3>Comment l\'utiliser ?</h3>
<p>Le code suivant crée une zone de contenu à onglets avec deux onglets.</p>
<pre><code>{tab_header name=\'tab1\' label=\'Tab One\'}
{tab_header name=\'tab2\' label=\'Tab Two\'}
...
$lang['help_function_cms_textarea'] = '<h3>Que fait cette balise ?</h3>
  <p>Ce plugin Smarty est utilisé lors de la construction des formulaires d\'administration pour générer un champ textarea. Il dispose de plusieurs paramètres qui permettent de contrôler si un plugin WYSIWYG est utilisé <em>(si disponible)</em> ou un éditeur de syntaxe colorée, pour influencer le comportement des modules, ainsi que la taille et l\'apparence du textarea.</p>
  <h3>Comment l\'utiliser ?</h3>
    <p>La façon la plus simple d\'utiliser ce plugin est de spécifier <code>{cms_textarea name = "quelque_chose"}</code>. Cela va créer une zone de texte simple, sans module WYSIWYG ou de syntaxe colorée, avec le nom spécifié.</p>
    <p>Ensuite, vous pouvez spécifier la valeur par défaut de la zone de texte en utilisant le "text" ou le paramètre "value".</p>
  <h3>Quels paramètres ?</h3>
  <ul>
    ...
    <li>cols - option integer : les colonnes de la zone de texte (peut être ignorer par le thème CSS admin ou le module de syntaxe/WYSIWYG).</li>
    <li>width - alias pour le paramètre "cols".</li>
    <li>rows - option integer : les lignes de la zone de texte (peut être ignorer par le thème CSS admin ou le module de syntaxe/WYSIWYG).</li>
    <li>height - alias pour le paramètre "rows".</li>
    <li>maxlength - option integer : attribut maxlength du textarea (peut être ignorer par le thème CSS admin ou le module de syntaxe/WYSIWYG).</li>
    <li>required  - option boolean : indique un champ obligatoire.</li>
    <li>placeholder - option string : attribut de l\'espace réservé du textarea (peut être ignorer par le thème CSS admin ou le module de syntaxe/WYSIWYG).</li>
    <li>value - option string : texte par défaut pour la zone de texte, va subir une conversion de l\'entité HTML.</li>
...
<li>cssname - option string : Passe le nom de cette feuille de style pour le module WYSIWYG, si un module WYSIWYG est activé.</li>
    ...
    <li>assign - option string : Affecte les résultats à une variable Smarty qui porte ce nom.</li>
  </ul';
...
<h3>Comment l\'utiliser ?</h3>
<p>Insérer la balise dans votre page ou votre gabarit : <code>{news}</code>. Pour de l\'aide à propos du module de news/articles, les paramètres etc..., merci de se référer à l\'aide du module News</p>';
...
<h3>Comment l\'utiliser ?</h3>
<p>Insérer la balise dans votre page ou votre gabarit : <code>{global_content name=\'myblock\'}</code>, où name est le nom du bloc de contenu que vous avez créer.</p>
<h3>Quels paramètres ?</h3>
<ul>
...
<p>C\'est une balise d\'administration qui affiche une alerte dans une page CMS Made Simple.</p>
<h3>Comment l\'utiliser ?</h3>
<ul>
...
<h3>Exemple :</h3>
<pre><code>{page_warning msg=\'Ha ! petit problème\'}</code></pre>';
...
<p>Maintenant, lorsque vous éditez une page, il y aura un texte intitulé "Second Content Block".</p></li>
	...
	<li><em>(option) </em>maxlength (positive integer) - Applicable uniquement lorsque l\'option "oneline" est utilisé ce paramètre optionnel permet de spécifier la longueur maximale d\'entrée pour le champ d\'édition. La valeur par défaut est de 255.</li>
	...
	<li><em>(option)</em> requis (true/false) - Permet de définir le bloc de contenu doit contenir du texte.
...
<li><em>(option)</em> cssname (string) - Un indice au module de l\'éditeur WYSIWYG pour utiliser le nom de feuille de style spécifié pour des styles étendus.</li>
...
<p>Ce plugin de fonction peut être utilisée pour fournir des conseils (astuces) pour le comportement du module si différents paramètres ne peuvent pas être indiqués sur l\'URL. Ex : Dans une situation où un site est configuré pour utiliser des "pretty" URLs pour le référencement, il est souvent impossible de fournir les paramètres supplémentaires des modules, comme un detailtemplate ou ordre de tri sur une URL. Ce plugin peut être utilisé dans les gabarits de page, blocs de contenu ou d\'une manière spécifique de la page pour donner des conseils quant à la façon dont les modules devraient se comporter.</p>
<p><strong>Note :</strong> Tous les paramètres qui sont spécifiés dans l\'URL remplaceront les conseils de module. Ex : Lorsque vous utilisez Articles (News) et si un paramètre "detailtemplate" est dans l\'URL, toutes les informations antérieures du "detailtemplate" n\'auront aucun effet.</p>
<p><strong>Note :</strong> Afin d\'assurer un comportement correct, les conseils de modules doivent être créés avant que la balise {content} soit exécuté dans le gabarit de la page CMSMS™. Par conséquent, ils devraient (normalement) être créés très tôt dans le processus de gabarit de la page. Un endroit idéal sur la page pour ces conseils serait la zone de texte "Balises Smarty spécifiques pour cette page" de l\'onglet "Logique" spécifique à cette page sur le formulaire "Éditer le contenu de la page".</p>
<h3>Quels paramètres ?</h3>
<ul>
  <li>module - <strong>requis string</strong> - Le nom du module auquel vous ajoutez l\'astuce.</li>
</ul>
<p>Les autres paramètres de cette balise stockés sous forme de conseils.</p>
<h3>Exemple :</h3>
<p>Lorsque vous utilisez le module Articles (News), avec des "pretty" URLs configurées. Vous souhaitez afficher les articles pour une catégorie spécifique sur une page, et que vous souhaitez utiliser un gabarit de détail non standard pour afficher les articles individuels sur une page différente. Ex : sur votre page "Sport" vous appelez News comme : <code>{News category=sports detailpage=sports_detail}</code>. Cependant, en utilisant des "pretty" URLs, il peut être impossible de spécifier un "detailtemplate" sur les liens qui permettront de générer les vues de détail. La solution est d\'utiliser la balise {cms_module_hint} sur <u>sports_detail</u> pour fournir des indications sur la façon dont doit se comporter News sur cette page.</p>
<p>Lors de l\'édition de la page <u>sports_detail</u> sur l\'onglet Options, dans la zone de texte "Balises Smarty spécifiques pour cette page" de l\'onglet "Logique" spécifique à cette page vous pouvez entrer une balise comme : <code>{cms_module_hint module=News detailtemplate=sports}</code>. Désormais, lorsqu\'un utilisateur clique sur un lien à partir du résumé de l\'articles (News) sur votre page "sports", il sera dirigé vers la page de <u>sports_detail</u>, et le modèle de détail de Articles (News) intitulé «sport» sera utilisé pour afficher l\'article.</p>
<h3>Usage :</h3>
...
<h3>Voir aussi :</h3>
<p>Voir la balise {form_start} qui est le complément à cette balise.</p>';
$lang['help_function_form_start'] = '<h3>Que fait cette balise ?</h3>
  <p>Elle crée une balise "form" pour une action de module. Cela est utile dans les gabarits de modules et s\'inscrit dans le cadre de la séparation de la conception du principe logique qui est au cœur de CMSMS.</p>
  <p>Cette balise accepte de nombreux paramètres qui peuvent utiliser la balise "form", y compris son style.</p>
<h3>Quels paramètres ?</h3>
<ul>
  ...
  <li>mid = <em>(option string)</em>
    <p>Le module actionId qui est la destination des données de formulaire. S\'il n\'est pas spécifié, une valeur est automatiquement calculée.</p>
  </li>
  <li>returnid = <em>(option integer)</em>
    <p>Le contenu de la page Id auquel le formulaire doit être soumis. S\'il n\'est pas spécifié, la page actuelle id est utilisé pour les demandes du site Web (frontend). Pour les demandes d\'administration cet attribut n\'est pas nécessaire.</p>
  </li>
  <li>inline = <em>(option integer)</em>
    <p>Une valeur booléenne qui indique que le formulaire doit être soumis en ligne (le traitement du formulaire remplace la balise originale) ou non (le traitement du formulaire remplace remplace la balise contenu {content}). Ce paramètre s\'applique uniquement aux demandes du site Web (frontend), et sa valeur est par défaut à false pour les demandes du site Web (frontend).</p>
  </li>
  ...
  <li>assign = <em>(option string)</em>
    <p>Assigne le résultat à une variable Smarty avec ce nom.</p>
  </li>
</ul>
<h3>Utilisation :</h3>
...
{form_end}</code></pre>
<h3>Exemple 2:</h3>
<p>Ce qui suit est un exemple de formulaire pour une utilisation dans l\'interface d\'un site web. Ajouté dans le contenu de la page, ce formulaire contient une "pagelimit", pour le soumettre au module Articles (News).</p>
...
$lang['function'] = 'Les balises "function" peuvent effectuer une tâche, ou interroger la base de données et afficher les résultats. Ils peuvent être appelés comme ; {tagname [attribute=value...]}';
$lang['modifier'] = 'Les balises "modifier" peuvent modifier la sortie d\'une variable Smarty. Ils sont appelés comme :{$variable|modifier[:arg:...]}';
$lang['postfilter'] = 'Les balises "postfilters" sont appelés automatiquement par Smarty après la compilation de chaque gabarit. Ils ne peuvent pas être appelés manuellement.';
$lang['prefilter'] = 'Les balises "prefilters" sont appelés automatiquement par Smarty avant la compilation de chaque gabarit. Ils ne peuvent pas être appelés manuellement.';
$lang['tag_about'] = 'Affiche des informations sur l\'historique et l\'auteur de ce plugin (si disponible).';
$lang['tag_adminplugin'] = 'Indique que la balise est disponible dans l\'interface d\'administration seulement, et, est généralement utilisé dans les gabarits de modules.';
